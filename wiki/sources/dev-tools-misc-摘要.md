...
`raw/tools/ci-cd/dev-tools-misc.md` — 开发工具合集：Docker 基本概念与常用命令、Protobuf 3 完整教程、dotnet CLI、SVN 版本控制、Obsidian 笔记系统
...
5. **Obsidian 笔记系统** — 目录设计原则（按领域划分/功能导向/≤3层）、文件命名技巧（关键词前置/状态标识/ISO 日期）、Admonition/Dataview 插件、Mermaid 图表、最佳实践（检索增强/定期归档/避过度分类）
